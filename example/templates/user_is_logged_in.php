...
<?php else : ?>
    <p><strong>You logged in through the login form</strong>, the "Remember me" cookie was <em>not</em> used for
        authentication.</p>
<?php endif; ?>
...
<ol>
    ...
    <li>Start Firefox and install the <a href="https://addons.mozilla.org/de/firefox/addon/6683/">Firecookie</a>
        extension if needed.
    </li>
    ...
    <li>Refresh the page - you are now logged in and should see this text. You have stolen the login credential from
        Chrome!
    </li>
